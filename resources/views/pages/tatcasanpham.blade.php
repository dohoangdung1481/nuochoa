...
@section('content')
    <section style="background-color: #eee;">
        <div class="text-center container py-5">
            <h3 class="mt-4 mb-5"><strong>Tất Cả Sản Phẩm</strong></h3>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                        <div class="text-center">
                                            <form action="{{ route('giohang.add', ['id' => $sp->san_pham_id]) }}"
                                                method="POST">
                                                @csrf
                                                ...
                                                <div class="input-group mb-3" style="max-width: 10rem; margin: 0 auto;">
                                                    <button type="button" class="btn btn-outline-secondary"
                                                        onclick="updateQuantity({{ $sp->san_pham_id }}, -1)"><i
                                                            class="bi bi-dash"></i></button>
                                                    <input type="number" name="qty" id="qty_{{ $sp->san_pham_id }}"
                                                        class="form-control text-center" value="1" min="1"
                                                        style="width: 4rem; -moz-appearance: textfield; -webkit-appearance: none; appearance: none;"
                                                        readonly>
                                                    <button type="button" class="btn btn-outline-secondary"
                                                        onclick="updateQuantity({{ $sp->san_pham_id }}, 1)"><i
